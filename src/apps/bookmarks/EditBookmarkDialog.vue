  ...
  <div class="dialog-overlay" @click.self="$emit('close')">
    <div class="dialog-content">
      ...
      <div class="dialog-body">
        ...
        <div class="form-group">
          <label>分类</label>
          <select v-model="editedBookmark.categoryId" class="form-select">
            <option 
      ...
      <div class="dialog-footer">
        ...
        <button class="btn btn-danger" @click="deleteBookmark" v-if="!editedBookmark.isDefault">
          删除
        </button>
...
export default {
  ...
  computed: {
    isValid() {
      return this.editedBookmark.title.trim() && 
             this.editedBookmark.url.trim() && 
             this.editedBookmark.categoryId
    }
  },
  methods: {
    submit() {
      if (this.isValid) {
        let url = this.editedBookmark.url.trim()
        ...
        this.$emit('save', {
          ...this.editedBookmark,
          title: this.editedBookmark.title.trim(),
          url: url
        })
      }
    },
    deleteBookmark() {
      this.$emit('delete', this.editedBookmark.id)
      this.$emit('close')
    }
  }
}
